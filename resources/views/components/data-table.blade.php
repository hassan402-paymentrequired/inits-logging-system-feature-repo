                    ...
                    <thead class="">
                        <tr class="p-4">
                            @if($type === 'visitors')
                                ...
                                <th data-sortable="true"><small class="fw-semibold text-muted">Staff ID</small></th>
                            @elseif($type === 'staffs')
                                <th data-sortable="true"><small class="fw-semibold text-muted">Name</small></th>
                                <th data-sortable="true"><small class="fw-semibold text-muted">Position</small></th>
                                <th data-sortable="true"><small class="fw-semibold text-muted">Department</small></th>
                                <th data-sortable="true"><small class="fw-semibold text-muted">Phone Number</small></th>
                            @endif
                        </tr>
                    </thead>
